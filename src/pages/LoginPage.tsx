			...
			<section className="py-10 px-15 w-full flex-1">
				...
				<BlurFade duration={0.7} delay={0.2} inView={true}>
					<form className="flex flex-col gap-5 text-textPrimary">
						<div className="flex flex-col gap-2">
							...
							<Input
								className="rounded-none text-xl focus-visible:border-b-indigo-500 border-b-slate-700 border-t-transparent border-l-transparent border-r-transparent"
								type="text"
							/>
						</div>
						<div className="flex flex-col gap-2">
						...
						<Button
							className="bg-indigo-600 hover:bg-indigo-500 py-6 text-white text-xl rounded-none"
							type="submit"
						>
							iniciar sesion
						</Button>
				...
				<BlurFade duration={0.7} delay={0.4} inView={true}>
					<div>
						...
						<Button
							className="bg-white w-full hover:bg-gray-300 py-6 text-slate-700 text-xl rounded-none font-light"
